...
import com.sakalti.create_re.content.decoration.slidingDoor.DoorControl;
...
import com.sakalti.create_re.foundation.gui.widget.TooltipArea;
...
public class ElevatorContactScreen extends AbstractSimiScreen {
	...
	public void init() {
		...
		Pair<ScrollInput, Label> doorControlWidgets =
			DoorControl.create_reWidget(x + 58, y + 57, mode -> doorControl = mode, doorControl);
