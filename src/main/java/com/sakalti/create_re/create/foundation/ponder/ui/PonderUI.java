...
import static com.sakalti.create_re.foundation.ponder.PonderLocalization.LANG_PREFIX;
...
import com.sakalti.create_re.foundation.ponder.PonderChapter;
...
import com.sakalti.create_re.foundation.ponder.PonderStoryBoardEntry;
...
import com.sakalti.create_re.foundation.utility.FontHelper;
...
import com.sakalti.create_re.infrastructure.ponder.DebugScenes;
...
public class PonderUI extends NavigatableSimiScreen {
	...
	protected void replay() {
		...
		if (hasShiftDown()) {
			...
			activeTemplate.placeInWorld(world, BlockPos.ZERO, BlockPos.ZERO, new StructurePlaceSettings(), RandomSource.create_re(),
