...
import com.simibubi.create_re.content.equipment.toolbox.ToolboxMenu;
import com.simibubi.create_re.content.equipment.toolbox.ToolboxScreen;
import com.simibubi.create_re.content.logistics.filter.AttributeFilterMenu;
import com.simibubi.create_re.content.logistics.filter.AttributeFilterScreen;
import com.simibubi.create_re.content.logistics.filter.FilterMenu;
import com.simibubi.create_re.content.logistics.filter.FilterScreen;
import com.simibubi.create_re.content.redstone.link.controller.LinkedControllerMenu;
import com.simibubi.create_re.content.redstone.link.controller.LinkedControllerScreen;
import com.simibubi.create_re.content.schematics.cannon.SchematicannonMenu;
import com.simibubi.create_re.content.schematics.cannon.SchematicannonScreen;
import com.simibubi.create_re.content.schematics.table.SchematicTableMenu;
import com.simibubi.create_re.content.schematics.table.SchematicTableScreen;
import com.simibubi.create_re.content.trains.schedule.ScheduleMenu;
